...
///
int File32::elfMachine() const {
	return h->e_machine;
}


///
int File32::elfOS() const {
...
public:
	...
	t::uint8 elfBind()	override { return ELF32_ST_BIND(_info->st_info); }
	t::uint8 elfType()	override { return ELF32_ST_TYPE(_info->st_info); }
